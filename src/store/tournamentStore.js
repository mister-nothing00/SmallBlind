...
export const useTournamentStore = defineStore("tournament", {
  ...
  actions: {
    ...
    //Players
    addPlayer(player) {
      // Aggiungiamo i contatori per rebuy e addon
      const newPlayer = {
        ...player,
        reBuyCount: 0,
        addOnCount: 0
    ...
    setPlayers(players) {
      // Assicuriamoci che tutti i giocatori abbiano i contatori
    ...
    // Nuova azione per aggiungere un rebuy a un giocatore
    ...
    // Nuova azione per aggiungere un addon a un giocatore
